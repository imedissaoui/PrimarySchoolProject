...
class  GestionEmploi extends Component {
  ...
  render() {
    ...
    const edit = "اتاحة التغيير";
    const submit = "الذهاب للجدول"
    return (
        ...
        <div  className={`${green.tablecontainer}  ${green.gestion}`}> 
            ...
            <hr />
            <tfoot align="center">
            <a id={green.plus}  onClick={() => this.hideComponent("showHide1") } class={`${green.btn} ${green.blue} ${green.circular}`} >{this.state.showHide1 ? submit : edit}</a> ;
